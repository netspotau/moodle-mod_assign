...
class mod_assign_extension_form extends moodleform {
    ...
    function definition() {
        ...
        // visible elements
        if ($batchusers) {
            $mform->addElement('static', 'applytoselectedusers', '', get_string('grantextensionforusers', 'assign', count(explode(',', $batchusers))));
        }
    ...
    function validation($data, $files) {
        ...
        if ($this->instance->cutoffdate && $data['extensionduedate']) {
            if ($this->instance->cutoffdate > $data['extensionduedate']) {
