...
class assign_feedback_file extends assign_feedback_plugin {
    ...
    public function view_batch_upload_files($users) {
        ...
        if ($mform->is_cancelled()) {
            ...
            $data = file_postupdate_standard_filemanager($data, 'files', $this->get_file_options(), $this->assignment->get_context(), 'assignfeedback_file', ASSIGNFEEDBACK_FILE_BATCH_FILEAREA, $USER->id);
            $fs = get_file_storage();
