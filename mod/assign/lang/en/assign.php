...
$string['cutoffdate_help'] = 'If set, the assignment will accept late submissions after the due date until the cut off date. After this date late submissions will not be accepted without an extension';
...
$string['extensionnotaftercutoffdate'] = 'Extension date must be after the cut off date';
