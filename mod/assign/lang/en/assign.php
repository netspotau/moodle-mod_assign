...
$string['cutoffdate_help'] = 'Cut-off date is the final date that submissions will be accepted for this assignment. Setting a due date and a cut off date means that late submissions will be accepted until the cut-off date.';
...
$string['duedate_help'] = 'This is when the assignment is due. If a cut-off date is also set, any assignments submitted after the due date are marked as late.';
...
$string['extensionnotbeforecutoffdate'] = 'Extension date must be before the cut-off date';
...
$string['submissionnoteditable'] = 'This assignment is not accepting submissions';
