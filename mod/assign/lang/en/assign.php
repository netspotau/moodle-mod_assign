...
$string['allowonlinetextsubmission'] = 'Allow online text submission';
$string['requireonlinetextsubmission'] = 'Require online text submission';
$string['allowmaxfiles'] = 'Maximum number of uploaded files';
$string['allowminfiles'] = 'Minimum number of uploaded files';
