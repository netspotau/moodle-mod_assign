...
class assign_submit_for_grading_page implements renderable {
     ...
     * @param int $coursemoduleid - The current course module id for constructing links
     * @param moodleform $confirmform - The confirmation form
     */
...
class assign_grading_summary implements renderable {
    ...
    public function __construct($participantcount, $submissiondraftsenabled,
                                ...
                                $submissionssubmittedcount, $duedate,
                                $coursemoduleid, $teamsubmission) {
