...
class mod_assign_grading_options_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('select', 'perpage', get_string('assignmentsperpage', 'assign'), $options, $classoptions);
        ...
        $mform->addElement('select', 'filter', get_string('filter', 'assign'), $options, $classoptions);

        // quickgrading
        if ($instance['showquickgrading']) {
            $mform->addElement('checkbox', 'quickgrading', get_string('quickgrading', 'assign'), '', $classoptions);
