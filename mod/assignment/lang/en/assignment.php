...
$string['configconvertmodassignonrestore'] = 'Convert assignments from the older assignment module to the new Moodle 2.3 assignment module when they are restored from a backup if the older assignment module has been disabled.';
...
$string['convertmodassignonrestore'] = 'Upgrade assignments to Moodle 2.3 assignment module on restore';
